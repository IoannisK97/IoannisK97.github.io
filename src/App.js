...
const App = () => {
  ...
  const [learningRateType, setLearningRateType] = useState('regular');  // Add state for learning rate type
    ...
    try {
      const response = await fetch('http://localhost:5000/api/gradient-descent', {
        ...
        body: JSON.stringify({
          ...
          learningRateType: learningRateType,  // Include learning rate type
      ...
      for (const point of allPoints) {
        ...
        // Pause for a short duration before plotting the next point
