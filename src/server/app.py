...
from gradient_descent_module import gradient_descent  # Import your gradient descent logic
...
# Endpoint for performing gradient descent with visualization
...
def perform_gradient_descent_with_visualization():
    ...
    # Create polynomial function from string
